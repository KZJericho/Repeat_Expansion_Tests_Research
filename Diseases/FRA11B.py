...
def FRA11B_Test(txt):
    ...
    if best_length < 1:
        return None
    elif best_length < 500:
        return "CCG/CGG Repeat Length:", best_length, "Location: Index", current_best_location, "Negative Result: Normal Allele"

        
    elif best_length >= 500:
        return "CCG/CGG Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Pathogenic Allele"
