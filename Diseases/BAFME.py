...
def BAFME_Test(txt):
    ...
    if best_length < 1:
        return None
    elif best_length <= 300:
        return "TTT(C/T)A Repeat Length:", best_length, "Location: Index", current_best_location, "Negative Result: Normal Allele"
        
    elif best_length in range(301,440):
        return "TTT(C/T)A Repeat Length:", best_length, "Location: Index", current_best_location, "Undetermined Result"
        
    elif best_length >= 440:
        return "TTT(C/T)A Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Pathogenic Allele"
