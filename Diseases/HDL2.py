...
def HDL2_Test(txt):
    ...
    elif best_length in range (29, 40):
        return "CTG Repeat Length:", best_length, "Location: Index", current_best_location, "Undetermined Result: Mutable Normal Allele OR Reduced-Penetrance Allele"
        
    elif best_length >= 40:
        return "CTG Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Full-Penetrance Allele"
