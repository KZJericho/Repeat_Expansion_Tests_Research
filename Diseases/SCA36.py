...
def SCA36_Test(txt):
    ...
    if best_length < 1:
        ...
        return "GGCCTG Repeat Length:", best_length, "Location: Index", current_best_location, "Negative Result: Normal Allele"
        
    elif best_length in range (15, 651):
        return "GGCCTG Repeat Length:", best_length, "Location: Index", current_best_location, "Undetermined Result"
        
    elif best_length > 650:
        return "GGCCTG Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Pathogenic Allele"
