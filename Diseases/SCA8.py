...
def SCA8_Test(txt):
    pats = ["CTA", "TAG", "CTG", "CAG"]
    results = None 
    print("Testing for SCA8...", end = "")
    ...
    if best_length < 1:
        ...
        return "(CTA/TAG)(CTG/CAG) Repeat Length:", best_length, "Location: Index", current_best_location, "Negative Result: Normal Allele"
        
    elif best_length in range (51,70):
        return "(CTA/TAG)(CTG/CAG) Repeat Length:", best_length, "Location: Index", current_best_location, "Undetermined Result: Intermediate Allele"
        
    elif best_length >= 70:
        return "(CTA/TAG)(CTG/CAG) Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Pathogenic Allele"
