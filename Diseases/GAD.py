...
def GAD_Test_Test(txt):
    pats = ["GCA"]
    results = None 
    print("Testing for GAD...", end = "")
    ...
    if best_length < 1:
        ...
        return "GCA Repeat Length:", best_length, "Location: Index", current_best_location, "Negative Result: Normal Allele"
        
    elif best_length >= 90:
        return "GCA Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Pathogenic Allele"
