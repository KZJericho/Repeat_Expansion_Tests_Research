...
def FECG_Test(txt):
    ...
    elif best_length in range (70, 121):
        return "CTG Repeat Length:", best_length, "Location: Index", current_best_location, "Negative Result: Intermediate Allele"
        
    elif best_length > 120:
        return "CTG Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Pathologic Allele"
