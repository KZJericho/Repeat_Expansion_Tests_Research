...
def FRAXF_Test(txt):
    ...
    if best_length < 1:
        ...
        return "GCC Repeat Length:", best_length, "Location: Index", current_best_location, "Negative Result: Normal Allele"
    
    elif best_length in range (27,300):
        return "GCC Repeat Length:", best_length, "Location: Index", current_best_location, "Undetermined Result: Intermediate Allele"
        
    elif best_length >= 300:
        return "GCC Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Pathogenic Allele"
