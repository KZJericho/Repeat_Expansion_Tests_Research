...
def FRAXE_Test(txt):
    ...
    if best_length < 1:
        ...
        return "CCG Repeat Length:", best_length, "Location: Index", current_best_location, "Negative Result: Normal Allele"
        
    elif best_length in range (41, 50):
        return "CCG Repeat Length:", best_length, "Location: Index", current_best_location, "Undetermined Result: Intermediate Allele"
        
    elif best_length in range (50,200):
        return "CCG Repeat Length:", best_length, "Location: Index", current_best_location, "Negative Result: Mutable Normal (Premutation) Allele"
        
    elif best_length >= 200:
        return "CCG Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Full-Penetrance Allele"
