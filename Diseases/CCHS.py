...
def CCHS_Test(txt):
    ...
    elif best_length in range (24,26):
        return "GCN Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Reduced-Penetrance Allele"
        
    elif best_length >= 26:
        return "GCN Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Full-Penetrance Allele"
