...
def C9ORF72_Test(txt):
    pat = "GGGGCC"
    print("Testing for C9ORF72_ALS_FTD...", end = "")
    ...
    elif best_length in range (25, 60):
        return "GGGGCC  Repeat Length:", best_length, "Location: Index", current_best_location, "Undetermined Result"
        
    elif best_length >= 60:
        return "GGGGCC  Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Pathogenic Allele"
