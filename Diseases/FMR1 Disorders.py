...
def FMR1_Disorders_Test(txt):
    pats = ["CGG", "AGG"]
    results = None 
    print("Testing for FMR1 Disorders...", end = "")
    ...
    elif best_length in range (45, 55):
        return "CGG Repeat Length:", best_length, "Location: Index", current_best_location, "Undetermined Result"
        
    elif best_length in range (55, 201):
        return "CGG Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result(FXTAS or FXPOI): Premutation Allele"
        
    elif best_length > 36:
        return "CGG Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result(FRAXA): Full-Penetrance Allele"
