...
def SCA31_Test(txt):
    ...
    if best_length < 1:
        return None
    elif best_length < 2500:
        return "TGGAA Repeat Length:", best_length, "Location: Index", current_best_location, "Negative Result: Normal Allele"
        
    elif best_length in range (2500, 3801):
        return "TGGAA Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Pathogenic Allele"
        
    elif best_length > 3800:
        return "TGGAA Repeat Length:", best_length, "Location: Index", current_best_location, "Undetermined Result"
