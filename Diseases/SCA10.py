...
def SCA10_Test(txt):
    ...
    if best_length < 1:
        ...
        return "ATTCT Repeat Length:", best_length, "Location: Index", current_best_location, "Negative Result: Normal Allele"
        
    elif best_length in range (33, 800):
        return "ATTCT Repeat Length:", best_length, "Location: Index", current_best_location, "Undetermined Result: No/Reduced Penetrance Allele"
    
    elif best_length in range (800, 850):
        return "ATTCT Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Reduced/Full Penetrance Allele"
        
    elif best_length > 850:
        return "ATTCT Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Full-Penetrance Allele"
