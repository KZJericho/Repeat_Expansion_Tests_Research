...
def SCA12_Test(txt):
    ...
    elif best_length in range (42, 43):
        return "CAG Repeat Length:", best_length, "Location: Index", current_best_location, "Undetermined Result: Intermediate Allele"
        
    elif best_length >= 43:
        return "CAG Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Pathogenic Allele"
