...
def FRA16A_Test(txt):
    ...
    if best_length < 1:
    ...
    elif best_length in range (50,300):
        ...
        return "CCG Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Pathogenic Allele"
