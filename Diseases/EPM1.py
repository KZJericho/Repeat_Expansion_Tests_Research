...
def EPM1_Test(txt):
    ...
    if best_length < 1:
        return None
    elif best_length in range (2,4):
        return "GGGGCC  Repeat Length:", best_length, "Location: Index", current_best_location, "Negative Result: Normal Allele"
        
    elif best_length in range (4, 30):
        return "GGGGCC  Repeat Length:", best_length, "Location: Index", current_best_location, "Undetermined Result"
        
    elif best_length >= 30:
        return "GGGGCC  Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Full-Penetrance Allele"
