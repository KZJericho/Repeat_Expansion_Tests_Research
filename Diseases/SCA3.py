...
def SCA3_Test(txt):
    ...
    elif best_length in range (45,53):
        return "CAG Repeat Length:", best_length, "Location: Index", current_best_location, "Undetermined Result: Intermediate Allele"
        
    elif best_length > 52:
        return "CAG Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Full-Penetrance"
