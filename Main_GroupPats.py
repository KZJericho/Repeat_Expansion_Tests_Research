...
def Group_Patterns_Test(txt, pats, results = None):
    ...
    if best_length < 1:
        ...
        return "CGG Repeat Length:", best_length, "Location: Index", current_best_location, "Positive Result: Full Penetrance"
        


        
# Maybe to cover generalizing results, create a list as follows for input
# results = [(I0, result0), (I1, result1), (I2, result2)...]
# This allows us to do the following:
"""
results = [(range(0,  45), "Negative Result: Normal Allele"), 
           (range(45, 54), "Undetermined Result"),
           (range(55,200), "Negative Result: Premutation Allele"),
           (range(200, 10**30), "Positive Result: Full-Penetration Allele")]
for (I, result) in results:
    if best_length in I:
        return (result, best_length, current_best_location
"""
